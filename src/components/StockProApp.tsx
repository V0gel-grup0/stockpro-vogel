    ...
    <div className={`app-shell ${!menuOpen ? "sidebar-closed" : ""}`}>
      ...
      <div className={`layout-grid ${!menuOpen ? "menu-collapsed" : ""}`}>
        ...
        <main className="main-content">
          ...
          {page === "Funcionários" && <Colaboradors role="funcionario" title="Colaboradores" currentUser={profile} search={search} />}
          {page === "Gerentes" && <Colaboradors role="gerente" title="Colaboradores" currentUser={profile} search={search} />}
          {page === "Vendedores" && <Colaboradors role="vendedor" title="Colaboradores" currentUser={profile} search={search} />}
          {page === "Técnicos" && <Colaboradors role="tecnico" title="Colaboradores" currentUser={profile} search={search} />}
...
function Colaboradors({ role, title, currentUser, search }: { role: Role; title: string; currentUser?: Profile } & SearchProps) {
    ...
    <section className="card">
      ...
      {showForm && <>
        ...
        <div className="form-grid">
          ...
          <SelectField label="Tipo de colaborador" value={form.item_type} onChange={(v) => { set("item_type", v); setSelectedEquipments([]); }}><option value="produto">Produto</option><option value="equipamento">Equipamento</option></SelectField>
